...
class _EnhancedHomeScreenState extends State<EnhancedHomeScreen> {
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(
              child: _buildActionButton(
                icon: provider.canManage
                    ? Icons.add_circle_outline
                    : Icons.person_outline,
                label: provider.canManage ? 'Crear Curso' : 'Mi Perfil',
                color: provider.canManage
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: AppStyles.spacingS),
                    Text(
                      '${progress.percentage.toStringAsFixed(0)}% completado',
                      style: AppTextStyles.bodySmall,
                    ),
                  ],
                ),
  ...
  Widget _buildFeaturedCourses(AppProvider provider) {
    ...
    final availableCourses = provider.courses
        .where(
            (c) => !c.isEnrolled && c.levelRequired <= provider.user!.level + 1)
        .take(3)
        .toList();
